  ...
  <formlayout>
    <template v-slot:default v-if="success === false && error === false">
      ...
      <form action="" class="form-body-cont">
        ...
        <div class="gen-wrapper mb-form">
          <mainbutton v-if="loading === false" :onClick="resetPassword" class="ml" size="max">Change Password</mainbutton>
          <mainbutton loading v-else class="ml" mode="loading" size="max">Changing Password</mainbutton>
        </div>
    ...
    <template v-slot:default v-else-if="success === true && error === false">
      <div class="mail-sent">
        <div class="mail-sent-top">
          ...
          <p class="mail-sent-title mbm">Password Changed</p>
          <p class="mail-sent-text mbm">Your password has been successfully changed.</p>
        </div>
      </div>
    </template>
    ...
    <template v-slot:default v-else >
      <div class="mail-sent">
        <div class="mail-sent-top">
          <img src="~/assets/svg/mail.svg" class="mail-sent-icon mbm" alt="" />
          <p class="mail-sent-title mbm">Password not Changed</p>
          <p class="mail-sent-text mbm">If you are having trouble changing your password, you can log out and request a password reset.</p>
        </div>
      </div>
    </template>
